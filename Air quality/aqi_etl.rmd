...
#   blastula::attach_connect_email(subject = paste("AQI exceeds",threshold, "for", nrow(bad_air), "measurements"))
} else {
  render_connect_email(here::here("Air quality", "email_good_air.rmd")) %>% 
